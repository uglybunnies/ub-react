...
export default () => (
    <div>
        ...
        <section className="ph2 standard">
            <h1 className="copy-header s1 m0 mb1">Proposed Platzner &amp; Co. Website</h1>
            <p>This is the design of a website for a small consultancy. The client chose to go in a different direction and paid for services rendered.</p>
